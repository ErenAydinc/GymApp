...
namespace Persistence.Migrations
{
    ...
    [Migration("20230215081701_mig_5")]
    partial class mig_5
    {
            ...
            modelBuilder.Entity("Core.Security.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FirstName = "gymapp",
                            LastName = "gymapp",
                            PasswordHash = new byte[] { 15, 210, 146, 28, 221, 212, 201, 192, 105, 31, 23, 235, 65, 78, 129, 218, 234, 190, 227, 87, 255, 45, 248, 19, 147, 129, 144, 168, 178, 38, 191, 154, 7, 218, 202, 74, 140, 184, 235, 220, 51, 107, 51, 161, 237, 162, 177, 142, 166, 236, 246, 44, 107, 180, 155, 35, 136, 190, 166, 163, 20, 9, 206, 28 },
                            PasswordSalt = new byte[] { 132, 203, 230, 123, 114, 71, 247, 41, 11, 74, 188, 230, 200, 207, 30, 12, 128, 58, 250, 131, 25, 6, 156, 1, 112, 89, 159, 153, 127, 101, 75, 248, 197, 242, 221, 237, 245, 56, 59, 133, 47, 239, 161, 11, 225, 185, 242, 253, 96, 140, 244, 172, 210, 180, 94, 48, 245, 182, 107, 187, 44, 96, 64, 230, 17, 81, 19, 196, 45, 138, 173, 89, 210, 253, 205, 47, 178, 123, 182, 227, 46, 16, 241, 51, 40, 173, 82, 241, 107, 6, 102, 11, 42, 99, 172, 89, 242, 4, 111, 204, 75, 69, 161, 171, 178, 245, 230, 116, 113, 114, 110, 87, 196, 92, 43, 120, 169, 238, 253, 156, 0, 57, 245, 71, 197, 139, 146, 11 },
                            Status = true
                        });
                });
