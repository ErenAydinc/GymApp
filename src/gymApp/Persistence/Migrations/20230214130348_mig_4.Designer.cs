...
namespace Persistence.Migrations
{
    ...
    [Migration("20230214130348_mig_4")]
    partial class mig_4
    {
            ...
            modelBuilder.Entity("Core.Security.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FirstName = "gymapp",
                            LastName = "gymapp",
                            PasswordHash = new byte[] { 5, 224, 160, 231, 63, 61, 180, 181, 54, 109, 78, 107, 152, 132, 167, 33, 227, 61, 251, 146, 220, 115, 83, 196, 33, 166, 214, 5, 105, 125, 164, 246, 160, 225, 250, 8, 48, 254, 232, 26, 122, 87, 206, 64, 205, 117, 92, 211, 250, 2, 236, 43, 184, 113, 114, 115, 2, 141, 241, 149, 54, 244, 242, 125 },
                            PasswordSalt = new byte[] { 163, 76, 88, 252, 0, 102, 232, 248, 220, 94, 148, 129, 156, 177, 52, 146, 103, 176, 20, 123, 190, 137, 248, 78, 150, 42, 188, 237, 78, 70, 242, 69, 240, 200, 12, 7, 62, 206, 170, 147, 241, 14, 176, 80, 49, 138, 95, 242, 233, 112, 196, 135, 233, 218, 195, 137, 137, 234, 56, 24, 183, 182, 58, 8, 193, 57, 82, 134, 195, 164, 28, 71, 192, 182, 91, 188, 89, 21, 198, 201, 139, 69, 140, 190, 56, 54, 233, 31, 10, 96, 57, 188, 34, 183, 54, 75, 223, 61, 112, 52, 5, 108, 98, 8, 197, 168, 127, 226, 222, 248, 157, 207, 117, 174, 100, 206, 210, 112, 214, 98, 35, 111, 77, 209, 179, 47, 5, 25 },
                            Status = true
                        });
                });
