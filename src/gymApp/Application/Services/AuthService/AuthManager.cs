...
namespace Application.Services.AuthService
{
    public class AuthManager : IAuthService
    {
        ...
        public async Task<RefreshToken> DeleteRefreshToken(RefreshToken refreshToken)
        {
            RefreshToken deletedRefreshToken = await _refreshTokenRepository.DeleteAsync(refreshToken);
